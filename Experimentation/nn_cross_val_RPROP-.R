...
write.csv(write_list, "CSV_maximum/one_layers_rprop_minus.csv")
...
write.csv(write_list, "CSV_maximum/two_layers_rprop_minus.csv")
...
write.csv(write_list, "CSV_maximum/three_layers_rprop_minus.csv")
